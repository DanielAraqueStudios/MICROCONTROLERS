...
pdf.cell(200, 10, txt=clean_text("Resumen de Proyectos de Investigación"), ln=True, align='C')
...
pdf.cell(200, 10, txt="1. SEIA - Semillero en Energias, Instrumentacion y Automatizacion", ln=True)
pdf.set_font('Arial', '', 12)
pdf.multi_cell(0, 10, txt=clean_text("""Grupo de Investigación VOLTA
...
pdf.set_font('Arial', '', 12)
pdf.multi_cell(0, 10, txt=clean_text("""IDEAS – Investigación en Desarrollo Sostenible
...
pdf.set_font('Arial', '', 12)
pdf.multi_cell(0, 10, txt=clean_text("""Universidad Militar Nueva Granada
...
pdf.set_font('Arial', '', 12)
pdf.multi_cell(0, 10, txt=clean_text("""Grupo de investigación: DAVINCI
...
output_path = "Resumen_Proyectos_Investigacion.pdf"
